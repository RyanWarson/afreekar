            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="name">
                        ...
                        <input type="text" id="name" name="name" placeholder="Nom du véhicule" required>
                    </div>
                ...
                <div class="form-group">
                    <div class="registration_number">
                        ...
                        <input type="text" id="registration_number" name="registration_number" rows="4"
                            cols="50" placeholder="Registration_number du véhicule" required>
                    </div>
                ...
                <div class="form-group row1">
                    <div class="col">
                        ...
                        <select id="type" name="type" <option value="Sedan">Sedan</option>
                    ...
                    <div class="col">
                        ...
                        <select id="transmission" name="transmission" <option value="Automatic">Automatique</option>
                ...
                <div class="form-group row">
                    <div class="col">
                        <input type="number" id="capacity" name="capacity" placeholder="Essence"required>
                    </div>
                    <div class="col">
                        <input type="number" id="seats" name="seats" placeholder="Nb. Passagers"required>
                    </div>
                    <div class="col">
                        <input type="number" id="price_per_day" name="price_per_day" placeholder="Prix par jour"required>
                    </div>
                </div>
